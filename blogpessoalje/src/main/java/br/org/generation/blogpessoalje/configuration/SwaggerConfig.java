package br.org.generation.blogpessoalje.configuration;
...
public class SwaggerConfig {
	...
	.basePackage("br.org.generation.blogpessoalje.controller"))
	...
	public static ApiInfo metadata() {
		...
		.title("API - Blog Pessoal Hora do Terror")
		.description("Projeto API Spring - Blog Pessoal Hora do Terror")
		.version("1.0.0")
		.license("Apache License Version 2.0")
		.licenseUrl("https://github.com/JessyOliver")//medei esse pelo meu https://github.com/rafaelq80
		.contact(contact())
		.build();
		}
		private static Contact contact() {
		return new Contact("Jessica Oliver",
		"https://github.com/JessyOliver",//mudei esse pelo meu https://github.com/rafaelq80
